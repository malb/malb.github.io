...
*** BROKEN Dual-Input Branching Programs
...
- cite:EPRINT:BMSZ15 is broken in polynomial time in cite:EPRINT:MilSahZha16.
- cite:C:PasSetTel14 is broken in polynomial time in cite:EPRINT:MilSahZha16.
- cite:EPRINT:GMMSSZ16 is broken in polynomial time in cite:EPRINT:CheGenHal16.
...
- cite:FOCS:GGHRSW13 is broken in subexponential-time (classical) and quantum polynomial-time attack in cite:EPRINT:CheGenHal16 This attack reveals a basis for the ideal generated by g and therefore we consider this a valid break
