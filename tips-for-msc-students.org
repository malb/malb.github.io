...
If you are doing a *technical* project with me, do not spend the first 20 pages with management speak and quoting Gartner reports on business projections. For example, when investigating the security of some software for remote file storage, do not start with an extensive account on “why private, public or hybrid clouds are excellent for businesses”. It is important to motivate a technical question but keep it brief.

Similarly, equip yourself with a good bullshit detector. You'll need it if you work in information security! Some bullshit signs in information security are:
