...
We also talk, abstractly, about torture. We also talk about the regulation of online speech in this lecture which means we will mention child sexual exploitation and abuse (CSEA).

** Oblivious Pseudorandom Functions (OPRFs)

We discuss oblivious pseudorandom functions (OPRFs) where a client and a server compute a PRF together, the client holding the input and receiving the output, the server holding the key. These objects are surprisingly versatile building blocks but post-quantum candidates leave much to be desired.

[[https://malb.github.io/7CCSMATC/lecture-oprf.pdf][slides]]

*Preparatory Reading*

- Friedrichs, K., Lehmann, A., & özbay, C. (2025). Game changer: A modular framework for OPRF
  security. In G. Hanaoka, & B. Yang, ASIACRYPT 2025, Part VIII (pp. 582–613). : Springer,
  Singapore. Sections 1 to 5 (24 pages)

** Fully Homomorphic Encryption (FHE)

We  discuss fully homomorphic encryption (FHE) which allows us to compute on encrypted data. This sounds kinda cool and actually also is. We then ask: what’s the point?

[[https://malb.github.io/7CCSMATC/lecture-fhe.pdf][slides]]

*Preparatory Reading*

- Gentry, C. (2010). Computing arbitrary functions of encrypted data. Commun. ACM, 53(3), 97–105.
  http://dx.doi.org/10.1145/1666420.1666444 (9 pages)

*Dramatis Personae*

- [[https://en.wikipedia.org/wiki/Vinod_Vaikuntanathan][Vinod Vaikuntanathan]]
- [[https://en.wikipedia.org/wiki/Craig_Gentry][Craig Gentry]]
- [[https://web.cs.ucla.edu/~sahai/][Amit Sahai]]
- [[https://www.cs.utexas.edu/~bwaters/][Brent Waters]]
